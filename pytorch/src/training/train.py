...
def main():
    ...
    if LOAD_MODEL:
        ...
        E = 10
        gen_D_checkpoint = f"{CHECKPOINT_GENERATOR_D}_{E}.pth.tar"
        gen_N_checkpoint = f"{CHECKPOINT_GENERATOR_N}_{E}.pth.tar"
        disc_D_checkpoint = f"{CHECKPOINT_DISCRIMINATOR_D}_{E}.pth.tar"
        disc_N_checkpoint = f"{CHECKPOINT_DISCRIMINATOR_N}_{E}.pth.tar"
